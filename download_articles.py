...
#load list of all article links
websites = []
with open ("links_metoo.txt", "rb") as f:
    websites = pickle.load(f)
f.close()

#use Article library from Newspaper3k for the download
documents = []
count_article = 0
for url in websites:
    count_article += 1
...
#Separate words and make lower-case to feed to Gensim Word2Vec constructor
